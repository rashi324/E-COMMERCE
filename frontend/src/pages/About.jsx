       ...
       <div className='text-2xl text-center pt-8 border-t'>
            ...
            <div className='my-10 flex flex-col md:flex-row gap-16'>
               ...
               <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
                  ...
                  <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni esse aperiam adipisci vero cum corporis officia eos voluptas impedit? Magnam assumenda temporibus quidem eligendi facilis blanditiis maxime exercitationem qui iste.</p>
               </div>
            </div>
         ...
         <div className='flex flex-col md:flex-row text-sm mb-20'>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    ...
                    <p className='text-gray-600'>Lorem ipsum dolor sit, amet consectetur adip. lorem10</p>
              </div>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    <b>Convenience:</b>
                    <p className='text-gray-600'>Lorem ipsum dolor sit, amet consectetur adipis</p>
              </div>
              <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
                    <b>Coustomer Service:</b>
                    <p className='text-gray-600'>Lorem ipsum dolor sit, amet consectetur t.</p>
              </div>
         </div>
